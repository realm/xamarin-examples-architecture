...
namespace SharedGroceries.Services
{
    public static class NavigationService
    {
        ...
        private static Page GetPageForViewModel(BaseViewModel viewModel)
        {
            ...
            {
                ShoppingListsCollectionViewModel => new ShoppingListsCollectionPage(),
                ShoppingListViewModel => new ShoppingListPage(),
                LoginViewModel => new LoginPage(),
                _ => throw new ArgumentException("The input ViewModel is not supported"),
            };
        }
    }
}
